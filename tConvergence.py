...
'''
This code corresponds to Example 1 (Table 3) of the [arXiv preprint](https://arxiv.org/abs/2404.13578)

Tested with NGSolve version 6.2.2404

dt-Convergence test for fully transient poroelasticity problem
...
maxlevels = 7 #number of time refinements
tend = 1 # Final time
pp = 5 # Polynomial degree
h = 1/16 # Mesh size
